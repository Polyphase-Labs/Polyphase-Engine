...
// Vulkan-only PCF directional-shadow sample. See Forward.frag for details.
...
void main()
{
    ...
    vec2 texCoord1 = kHasUv1 ? ((sourceUv1 + material.mUvOffset1) * material.mUvScale1) : sourceUv0;
