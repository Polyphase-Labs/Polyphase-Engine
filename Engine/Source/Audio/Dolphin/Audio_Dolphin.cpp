...
// Streaming voices — not implemented on GameCube/Wii. Returning 0 from AUD_OpenStream tells
// callers (e.g. the VideoPlayer addon) to fall back to video-only playback.
