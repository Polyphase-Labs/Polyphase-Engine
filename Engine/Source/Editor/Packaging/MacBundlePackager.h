 ...
 * Mach-O with Makefile_Mac_Game exactly like Linux (MAC_ARCH= from the
 * profile's Architecture option selects arm64 / x86_64 / universal). PostPackage then
 ...
 * unsigned native code, and install_name_tool invalidates the linker's
