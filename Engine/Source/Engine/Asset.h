...
#define ASSET_VERSION_SCENE_OCCLUSION_DYNAMIC 41
#define ASSET_VERSION_SCENE_OCCLUSION_ALGO 42
#define ASSET_VERSION_INPUT_PROMPT_MAP_PLATFORM_MAC 43
#define ASSET_VERSION_CURRENT 43
// ----------------------------------------------------
