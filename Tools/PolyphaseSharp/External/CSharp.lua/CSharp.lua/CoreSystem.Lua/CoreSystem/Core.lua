...
-- POLYPHASE PATCH: expose pending (registered but not yet init'd) module names so
-- the per-file CSharpCore.Finalize() glue can System.init exactly what one
-- generated script file registered. See Tools/PolyphaseSharp/External/CSharp.lua/VENDOR.md.
