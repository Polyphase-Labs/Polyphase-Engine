...
npx proof-of-usage hash \
  ...
  --repo "https://github.com/Polyphase-Labs/Polyphase-Engine"
```

```bash
printf '%s' "ExampleModel v2:AI Corp:2026-08-12T14:30:00Z:https://github.com/Polyphase-Labs/Polyphase-Engine" | shasum -a 256
```

```python
import hashlib
hashlib.sha256("ExampleModel v2:AI Corp:2026-08-12T14:30:00Z:https://github.com/Polyphase-Labs/Polyphase-Engine".encode()).hexdigest()
```
