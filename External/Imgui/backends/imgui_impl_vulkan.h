...
IMGUI_IMPL_API void         ImGui_ImplVulkan_DestroyFontsTexture(); // Polyphase: backport of the 1.90 API so the atlas can be rebuilt at runtime. Device must be idle.
